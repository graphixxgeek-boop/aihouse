...
export const PRESTATIONS = [
  ...
  { nom: "Pack Fidélité du ton", description: "Envoie de vraies provocations au vrai modèle et affiche les réponses telles quelles, pour une lecture humaine. Le seul outil qui touche la sortie RÉELLE des personnages.", demande: "Vérifier que le ton de Lia et Noé n'a pas dérivé (Article 0)", outils: ["check-spirit"], cout: "réel — 16 vrais appels Gemini, consulter Smart Conso API avant", tokensEstimes: "faible côté agent ; le coût est en appels API, pas en tokens" },
