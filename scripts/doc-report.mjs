...
export const REGISTRIES = [
  ...
  { slug: "check-level-target", label: "CHECK-LEVEL-TARGET", family: "Gouvernance interne (Smart Conso)", path: "docs/check-level-target/", decision: "texte", scriptPath: "scripts/check-level-target.mjs" },
  { slug: "smart-conso-api", label: "Smart Conso API", family: "Gouvernance interne (Smart Conso)", path: "docs/smart-conso-api/", decision: "texte", scriptPath: "scripts/smart-conso-api.mjs" },
  { slug: "smart-conso-token", label: "SMART-CONSO-TOKEN", family: "Gouvernance interne (Smart Conso)", path: "docs/smart-conso-token/", decision: "texte", scriptPath: "scripts/smart-conso-token.mjs" },
