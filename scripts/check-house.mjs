...

{
  ...
  assert.equal(report.length, 26, 'buildCircleReport() must return exactly one entry per CIRCLE_ITEMS item, in the same order, never dropping or reordering one — 26 since organigramme-signal joined CIRCLE_ITEMS on 2026-09-22, after check-tasks-report and hyper-scan-checkpoint-light the same day');
