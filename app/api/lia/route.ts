...
export async function POST(request: Request) {
    ...
    try {
        ...
        if(ambientBeat){const [firstLine,secondLine]=seedPick(story.seed,"beat-ambient",[
            ...
            ["Cette plante aux feuilles bleues n’a jamais poussé nulle part, ça se voit au premier coup d’œil. Et cette enceinte, une fois allumée, dessine des notes sans le moindre son.","Une image de musique, littéralement. Ça résume assez bien cette baraque : tout est visible, rien n’existe vraiment."],
            ...
            ["Ces feuilles bleues géométriques n’ont jamais connu la sève. Et l’enceinte, une fois branchée, affiche des notes muettes.","Une apparence de musique sans la moindre vibration. Ça dit tout de cet endroit."],
